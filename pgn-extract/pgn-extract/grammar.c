 ...
 * each variation separately. This is done recursively.
        ...
        while(move != NULL) {
            ...
            while (variants != NULL) {
                if(variants->suffix_comment != NULL) {
                    append_comments_to_move(move, variants->suffix_comment);
        ...
        while(move != NULL) {
            ...
            while (variants != NULL) {
                ...
                if(variant_moves != NULL) {
                    ...
                    if(prefix_comment != NULL) {
                        append_comments_to_move(prev, prefix_comment);
                    }
                    output_game(game, outputfile);
                    if(prefix_comment != NULL) {
                        /* Remove the appended comments. */
                        CommentList *comment = prev->comment_list;
                        if(comment == prefix_comment) {
                            prev->comment_list = NULL;
                        }
                        else {
                            while(comment->next != prefix_comment && comment->next != NULL) {
